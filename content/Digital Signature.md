...
发送方会利用 [[Cryptographic Hash]] 来给原本的明文生成一个摘要（Digest），摘要的本质是明文的一个压缩镜像，如下所示：

![](2024-03-26_16-46-48_screenshot.png)

然后发送方再将摘要用私钥加密生成签名（Signature），附在明文之后：

![](2024-03-26_16-49-13_screenshot.png)

接受方收到信件后，为了检验完整性，可以用发送方的公钥解密签名，得到摘要，在和自己收到的明文生成的摘要进行比对，如果一致则说明没有被篡改。

![](2024-03-26_16-55-52_screenshot.png)
